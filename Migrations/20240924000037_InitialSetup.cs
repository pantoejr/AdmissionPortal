    ...
    public partial class InitialSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountyTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasEntered = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CollegeTypeID = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisabilityAttribute = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CountyOfHighSchoolAttended = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HighSchoolAttendedName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StartYear = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndYear = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NameOfUniversity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UniversityCountryID = table.Column<int>(type: "int", nullable: true),
                    UniversityStartYear = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UniversityEndYear = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CollegeID = table.Column<int>(type: "int", nullable: true),
                    DepartmentID = table.Column<int>(type: "int", nullable: true),
                    DegreeID = table.Column<int>(type: "int", nullable: true),
                    EntryYear = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applicants_Colleges_CollegeID",
                        column: x => x.CollegeID,
                        principalTable: "Colleges",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Applicants_CountryTypes_CountryID",
                        column: x => x.CountryID,
                        principalTable: "CountryTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Applicants_CountryTypes_UniversityCountryID",
                        column: x => x.UniversityCountryID,
                        principalTable: "CountryTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Applicants_CountyTypes_CountyID",
                        column: x => x.CountyID,
                        principalTable: "CountyTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Applicants_Degrees_DegreeID",
                        column: x => x.DegreeID,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applicants_Nationalities_NationalityID",
                        column: x => x.NationalityID,
                        principalTable: "Nationalities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Applicants_OccupationTypes_OccupationID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applicants_OccupationID",
                table: "Applicants",
                column: "OccupationID");

            migrationBuilder.CreateIndex(
                name: "IX_Applicants_RelationshipTypeID",
                table: "Applicants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applicants_TitleID",
                table: "Applicants",
                column: "TitleID");

            migrationBuilder.CreateIndex(
                name: "IX_Applicants_UniversityCountryID",
                table: "Applicants",
